...
| Splash |
|:------:|
| <img src="./docs/splash움짤.gif" width="250"> |
...
| 회원가입 1단계 | 회원가입 2단계 |
|:-------------:|:-------------:|
| <img src="./docs/회원가입1움짤.gif" width="250"> | <img src="./docs/회원가입2움짤.gif" width="250"> |
...
| 피드 | 팔로우 없을 때 |
|:----:|:-------------:|
| <img src="./docs/홈피드2움짤.gif" width="250"> | <img src="./docs/팔로우_없을_때_움짤.gif" width="250"> |
...
| 작성 | 상세 · 좋아요 · 댓글 |
|:----:|:--------------------:|
| <img src="./docs/게시물작성움짤.gif" width="250"> | <img src="./docs/게시글상세움짤.gif" width="250"> |
...
| AI 글 생성 |
|:----------:|
| <img src="./docs/ai생성움짤.gif" width="250"> |
